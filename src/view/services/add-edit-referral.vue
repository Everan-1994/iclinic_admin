        ...
        <Row>
          ...
          <Col span="8">
            <FormItem label="性别代码" prop="xbdm">
              <Input v-model="formValidate.xbdm" placeholder="性别代码"></Input>
            </FormItem>
          </Col>
          <Col span="8">
        ...
        <Row>
          <Col span="6">
            <FormItem label="转诊日期及时间" prop="zzsj">
              <DatePicker v-model="formValidate.zzsj" type="date" placeholder="请选择转诊日期及时间"></DatePicker>
            </FormItem>
          </Col>
          <Col span="6">
                    ...
                    referralDetail(id).then(function (res) {
                        if (res.data.errorCode === 0) {
                            ...
                            that.formValidate = {
                                ...
                                nls: data.nls, nly: data.nly, jzrqsj: data.jzrqsj, fzysgh: data.fzysgh,
                                fzysxm: data.fzysxm, fzksbm: data.fzksbm, fzksmc: data.fzksmc, zzyy: data.zzyy,
                                zzsj: data.zzsj, zxjgdm: data.zxjgdm, zxjgmc: data.zxjgmc, zxksbm: data.zxksbm,

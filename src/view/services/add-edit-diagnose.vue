                ...
                <Row>
                    ...
                    <Col span="8">
                        <FormItem label="中医诊断编码类型" prop="zyzdbmlx">
                            <Input v-model="formValidate.zyzdbmlx" placeholder="中医诊断编码类型"></Input>
                        </FormItem>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col span="6">
                        <FormItem label="诊断标志" prop="zdbz">
                            <Input v-model="formValidate.zdbz" placeholder="诊断标志"></Input>
                        </FormItem>
                    </Col>
                    <Col span="6">
                    ...
                    <Col span="6">
                        <FormItem label="诊断时间">
                            <DatePicker v-model="formValidate.zdsj" type="date" placeholder="请选择诊断时间"></DatePicker>
                        </FormItem>
                    </Col>
                </Row>
                <Row>
        ...
        data() {
            return {
                ...
                ruleValidate: {
                    ...
                    xyzdbmlx: [
                        {required: true, message: '请填写西医诊断编码类型', trigger: 'blur'}
                    ],
                    zdysgh: [
                        {required: true, message: '请填写诊断医生工号', trigger: 'blur'}
                    ],
                    zdbz: [
                        {required: true, message: '请填写诊断标志', trigger: 'blur'}
                    ],
                    zdsm: [
                        {required: true, message: '请填写诊断说明', trigger: 'blur'}
                    ],
                    zyzdbmlx: [
                        {required: true, message: '请填写中医诊断编码类型', trigger: 'blur'}
                    ],
                    xyzdmc: [

        ...
        <Card>
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
                ...
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="职务代码" prop="zyjszwdm">
                            <Select v-model="formValidate.zyjszwdm" clearable>
                                <Option v-for="(p, index) in position" :key="index" :value="p.code">{{ p.name }}</Option>
                            </Select>
                        </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="6">
                        <FormItem label="职务类别代码" prop="zyjszwlbdm">
                            <Select v-model="formValidate.zyjszwlbdm" clearable>
                                <Option v-for="(p, index) in position_class" :key="index" :value="p.code">{{ p.name }}</Option>
                            </Select>
                        </FormItem>
                    </Col>
                    <Col span="6">
                ...
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="全科医生标志" prop="qkysbz">
                            <Select v-model="formValidate.qkysbz" clearable>
                ...
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="学历" prefix="xl">
                            <Input v-model="formValidate.xl" placeholder="个人照片存放地址"></Input>
                        </FormItem>
                    </Col>
                    <Col span="6">
                ...
                <Row>
                    <Col span="12">
                        <FormItem label="资格证存放地址" prefix="zgzcfdz">
                            <Input v-model="formValidate.zgzcfdz" placeholder="资格证存放地址"></Input>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <FormItem label="执业证存放地址" prefix="zyzcfdz">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            this.getSelectList('position')
            this.getSelectList('position_class')
        },
        methods: {
            getSelectList(name) {
                let _this = this
                    ...
                    humanDetail(id).then(function (res) {
                        if (res.data.errorCode === 0) {
                            ...
                            that.formValidate = {
                                ...
                                sfzh: data.sfzh,
                                ksdm: data.ksdm,
                                zyjszwdm: data.zyjszwdm,
                                zyjszwlbdm: data.zyjszwlbdm,
                                zzlbmc: data.zzlbmc,
                                zgzsbm: data.zgzsbm,
                                zghdsj: data.zghdsj,
                                zyzsbm: data.zyzsbm,
                                ...
                                zydd: data.zydd,
                                zyfw: data.zyfw,
                                zyzyyljgdm: data.zyzyyljgdm,
                                zyzyyymc: data.zyzyyymc,
                                qkysbz: data.qkysbz,
                                sjhm: data.sjhm,
                                zc: data.zc,
                                mc: data.mc,
                                ...
                                zcsj: data.zcsj,
                                xl: data.xl,
                                grzpcfdz: data.grzpcfdz,
                                zgzcfdz: data.zgzcfdz,
                                zyzcfdz: data.zyzcfdz,
                                sjscsj: data.sjscsj,
                                tbrqsj: data.tbrqsj,
                                cxbz: data.cxbz
                            }

        ...
        <Card>
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="机构数量" prop="pcjgsl">
                    ...
                    <Col span="6">
                        <FormItem label="部署平台" prop="bspt">
                            <Select v-model="formValidate.bspt" clearable>
                                ...
                                <Option value="02">阿里云</Option>
                                <Option value="03">腾讯云</Option>
                                <Option value="04">天翼云</Option>
                                <Option value="05">沃云</Option>
        ...
        data() {
            return {
                ...
                ruleValidate: {
                    ...
                    jzc: [
                        {required: true, type: 'number', message: '请填写净资产', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    fz: [
                        {required: true, type: 'number', message: '请填写负债', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    wxzcjkbf: [
                        {required: true, type: 'number', message: '请填写无形资产及开办费', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    gdzc: [
                        {required: true, type: 'number', message: '请填写固定资产', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    dwtz: [
                        {required: true, type: 'number', message: '请填写对外投资', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    ldzc: [
                        {required: true, type: 'number', message: '请填写流动资产', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    zzc: [
                        {required: true, type: 'number', message: '请填写总支出', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    zzch: [
                        {required: true, type: 'number', message: '请填写总资产', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    zsr: [
                        {required: true, type: 'number', message: '请填写总收入', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    ywyfmj: [
                        {required: true, type: 'number', message: '请填写业务用房面积', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    khfwryzs: [
                        {required: true, type: 'number', message: '请填写客户服务人员总数', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    zgzs: [
                        {required: true, type: 'number', message: '请填写职工总数', trigger: 'blur', transform:(value) => Number(value)}
                    ],
                    bspt: [
                    ...
                    odiDetail(id).then(function (res) {
                        if (res.data.errorCode === 0) {
                            ...
                            that.formValidate = {
                                ...
                                pcjgsl: data.pcjgsl,
                                bspt: data.bspt,
                                wljgtdz: data.wljgtdz,
                                jgmsxx: data.jgmsxx,
                                jfmj: data.jfmj,
                                zgzs: data.zgzs,
                                khfwryzs: data.khfwryzs,
                                zsr: data.zsr,
                                zzc: data.zzc,
                                zzch: data.zzch,
                                ldzc: data.ldzc,
